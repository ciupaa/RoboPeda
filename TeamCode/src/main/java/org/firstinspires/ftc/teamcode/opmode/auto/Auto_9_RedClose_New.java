...
import org.firstinspires.ftc.teamcode.config.paths.Paths_9_RedClose_New;
...
/**
 * FILE: Auto_9_RedClose_New.java
 * PURPOSE: 9-Point Autonomous – RED ALLIANCE, CLOSE side, NEW path sequence.
 *
 * Mirrored version of Auto_9_BlueClose_New for the Red alliance field position.
 *
 * NEW SEQUENCE (vs original 9pt Red Close):
 ...
 *
 * CAMERA PIPELINE: 1 (AprilTag – Red target TAG 24)
 *
 * Step-by-step:
 ...
 */
@Autonomous(name = "9pt Red Close NEW", group = "Competition")
public class Auto_9_RedClose_New extends OpModeCommand {

    private Robot_camera r;

    @Override
    public void initialize() {
        // 1. Initialize Robot with Camera – RED alliance
        r = new Robot_camera(hardwareMap, Alliance.RED);

        // 2. Build paths
        Paths_9_RedClose_New p = new Paths_9_RedClose_New(r);
            ...
            switch (state) {
                ...
                case WAIT_CAMERA:
                    ...
                    if (robot.limelight.hasTarget()) {
                        ...
                        // No target – use defaults
                        state = State.SPINUP_STABLE;
                    }
                    // Spin up immediately while waiting
