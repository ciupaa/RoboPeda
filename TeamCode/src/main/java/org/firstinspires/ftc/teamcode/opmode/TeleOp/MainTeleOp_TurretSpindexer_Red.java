...
/**
 * Red alliance TeleOp: turret tracks goal, velocity-compensated launch.
 * Goal position is set for the RED side of the field (mirrored from Blue).
 */
@Config
@Configurable
@TeleOp(name = "MainTeleOp Turret+Spindexer RED", group = "Competition")
public class MainTeleOp_TurretSpindexer_Red extends OpMode {

    private Robot_v2 r;

    /** Goal position in field coords (inches). Tune for RED alliance. */
