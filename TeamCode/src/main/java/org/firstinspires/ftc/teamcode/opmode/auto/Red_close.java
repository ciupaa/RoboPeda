...
public class Red_close extends OpModeCommand {
    ...
    public void loop() {
        ...
        telemetry.addLine("=== RED CLOSE AUTO (DIAGNOSTIC) ===");
        ...
        // Starting pose check
        telemetry.addLine("");
        telemetry.addLine("=== START POSE CHECK ===");
        telemetry.addData("Expected X", "106.876");
        telemetry.addData("Expected Y", "135.654");
        telemetry.addData("Expected Heading", "-90 deg");
