...
import org.firstinspires.ftc.teamcode.config.paths.Paths_9_RedClose_New2;
import org.firstinspires.ftc.teamcode.config.util.Alliance;
import org.firstinspires.ftc.teamcode.config.util.OpModeCommand;

/**
 * FILE: Auto_9_RedClose_New2.java
 * PURPOSE: 9-Point Autonomous – RED ALLIANCE, CLOSE side, NEW2 path sequence.
 *
 * Uses Paths_9_RedClose_New2 (updated coordinates from 9_AutoRed_Close_(1).pp).
 * Logic identical to Auto_9_RedClose_New.
 *
 ...
 */
@Autonomous(name = "9pt Red Close NEW2", group = "Competition")
public class Auto_9_RedClose_New2 extends OpModeCommand {
    ...
    public void initialize() {
        ...
        // 2. Build paths
        Paths_9_RedClose_New2 p = new Paths_9_RedClose_New2(r);
