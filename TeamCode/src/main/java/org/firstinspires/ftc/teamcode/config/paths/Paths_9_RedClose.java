...
/**
 * FILE: Paths_9_RedClose.java
 * PURPOSE: 9-Point Autonomous paths for RED ALLIANCE, CLOSE side.
 *
 * Mirrored version of Paths_9_BlueClose.
 *
 * Sequence:
 ...
 *  11. OutOfTriangle – Park outside scoring triangle
 */
public class Paths_9_RedClose {
    ...
    public Paths_9_RedClose(Follower follower) {
        ...
        // Path 11: OutOfTriangle – Curve to parking position
        // Heading: 43° → 0°
        OutOfTriangle = follower.pathBuilder()
                .addPath(new BezierCurve(
                        new Pose(94.000, 93.000),
                        new Pose(105.835, 88.661),
                        new Pose(120.376, 90.450)
                ))
                .setLinearHeadingInterpolation(Math.toRadians(43), Math.toRadians(0))
                .build();
    }
