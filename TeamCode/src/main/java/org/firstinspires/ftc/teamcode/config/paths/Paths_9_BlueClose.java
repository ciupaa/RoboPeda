...
/**
 * FILE: Paths_9_BlueClose.java
 * PURPOSE: 9-Point Autonomous paths for BLUE ALLIANCE, CLOSE side.
 *
 * Sequence:
...
public class Paths_9_BlueClose {
    ...
    public Paths_9_BlueClose(Follower follower) {
