...
import org.firstinspires.ftc.teamcode.config.paths.Paths_12_BlueClose_New;
import org.firstinspires.ftc.teamcode.config.util.Alliance;
import org.firstinspires.ftc.teamcode.config.util.OpModeCommand;

/**
 * FILE: Auto_12_BlueClose_New.java
 * PURPOSE: 12-Point Autonomous – BLUE ALLIANCE, CLOSE side, NEW path sequence.
 *
 * Extends the 9-point NEW2 close sequence with a third intake/shoot cycle (Artifact 3).
 * Uses Paths_12_BlueClose_New (coordinates from 12_AutoBlue_Close_(1).pp).
 *
 ...
 *  11.  GoTo3         – Drive to artifact 3 approach, intake on
 *  12.  Intake3       – Drive through artifact 3 while intaking
 *  13.  Shoot3        – Drive back to scoring position, shoot
 *  14.  Park          – Drive to park
 */
@Autonomous(name = "12pt Blue Close NEW", group = "Competition")
public class Auto_12_BlueClose_New extends OpModeCommand {
    ...
    public void initialize() {
        ...
        // 2. Build paths
        Paths_12_BlueClose_New p = new Paths_12_BlueClose_New(r);
