 ...
 * PURPOSE: Blue Alliance Far Position
 *
 ...
 * - Intake1: Final approach to artifact 1 (deeper: x=9)
        ...
        public Paths(Follower follower) {
            ...
            GoTo1 = follower.pathBuilder().addPath(
                            new BezierCurve(
                                    ...
                                    new Pose(44.000, 35.4)
                            )
                    ).setLinearHeadingInterpolation(Math.toRadians(118), Math.toRadians(180))
                    .build();

            // Intake1 - Straight line to artifact 1 (deeper than Alt: x=9)
